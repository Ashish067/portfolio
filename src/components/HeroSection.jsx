...
const HeroSection = () => {
  ...
  return (
    <div className="sm:px-4 lg:relative bg-[#111827] w-full h-auto flex justify-center items-center py-10 md:rounded-3xl shadow-2xl md:w-full">
      <div className="hero-section text-white flex flex-col md:flex-row items-start justify-between lg:w-[1080px] md:flex md:items-center">
